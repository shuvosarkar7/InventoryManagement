    ...
    <div class="card-body">
        ...
        @csrf
            ...
            <div class="position-relative form-group">
                <label for="PurchaseType" class="">Purchase Id</label>
                <select name="select" id="PurchaseType" class="form-control">
                    <option value="1">Purchase Id 1</option>
                    <option value="1">Purchase Id 2</option>
                    <option value="1">Purchase Id 3</option>
                    <option value="1">Purchase Id 4</option>
                    <option value="1">Purchase Id 5</option>
                </select>
            </div>
            ...
            <button class="mt-1 btn btn-primary">Add New Purchase</button>
        </form>
    </div>
</div>
